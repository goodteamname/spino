...
# Import data - - USER TO SPECIFY DATA BELOW.
ts = pd.read_csv("./bokeh_app/data/test_timeseries.csv", skiprows=1,
                 delimiter=",", names=['time', 'y1', 'y2', 'y3'])

# Using dataframe ts to create a seperate histogram dataframe for tab 1.
hist_ts = ts.copy()
